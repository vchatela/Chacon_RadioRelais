...
//C'est le codage de manchester, ceci permet entre autres de dissocier les données des parasites
...
//recoit en parametre un booleen définissant l'arret ou la marche du matériel (true = on, false = off)
...
int main (int argc, char** argv)
{
	...
	//first of all move to realtime scheduler to not be disturbed.
	scheduler_realtime();
